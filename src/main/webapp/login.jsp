...
<body>
	...
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/img/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 35pt;">基于java的机票售票系统</div></td>
	 </tr>
	 <tr>
		<td width="559">
			<form name="ThisForm" method="POST" action="/admin/login.do">
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2" valign="top">&nbsp; &nbsp; &nbsp; &nbsp;
						  记住我：<input type="checkbox" name="remember" value="true">
							<input name="button" type="submit" class="submit1" value="登录" onclick=""> &nbsp;
